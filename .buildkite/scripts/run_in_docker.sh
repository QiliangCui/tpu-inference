...
ENV_VARS=(
  ...
  -e ENABLE_EXPERT_PARALLEL="${ENABLE_EXPERT_PARALLEL:-0}"
  -e USE_MOE_EP_KERNEL="${USE_MOE_EP_KERNEL:-0}"
  -e PHASED_PROFILING_DIR="${PHASED_PROFILING_DIR:-}"
  ...
  -e FUSED_EP_BT_OVERRIDE="${FUSED_EP_BT_OVERRIDE:-0}"
  -e FUSED_EP_USE_FORI_LOOP="${FUSED_EP_USE_FORI_LOOP:-0}"
